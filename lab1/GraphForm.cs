...
public partial class GraphForm : Form
{
    ...
    private void DrawGraphButton_Click(object sender, EventArgs e)
    {
        ...
        if (sender is Size)
        {
            ...
            Size newSize = new(pictureBox1.Width + size.Width, pictureBox1.Height + size.Height);
            pictureBox1.Size = newSize;
            pictureBox1.Image = new Bitmap(newSize.Width, newSize.Height);
        }
    ...
    private void Draw(Bitmap bitmap, List<PointF[]> points)
    {
        ...
        points.ForEach(p => graphics.DrawCurve(pen, p));
    }
    ...
    public void GraphForm_ResizeEnd(object sender, EventArgs e) => DrawGraphButton_Click(sender, e);
